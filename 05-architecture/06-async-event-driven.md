...
> 同步调用像打电话——拨过去就得等对方接、说完、挂，对方占线你就一直卡着；异步 / 事件驱动像发消息——发出去就走，不耽误自己的事。这篇讲怎么用"事件"把系统的协作方式从"打电话"改成"发消息"，以及这样改能带来什么、付出什么代价。
...
![AI 异步任务时序图](https://cdn.jsdelivr.net/gh/Aimee1608/backend-notes@main/05-architecture/img/06-ai-async-task.png)
